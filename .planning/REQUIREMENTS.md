...
- [x] **AI-04**: User can find similar past trades by AI-detected pattern type
- [x] **AI-05**: User can view aggregate performance stats per pattern type (win rate, avg P&L)
