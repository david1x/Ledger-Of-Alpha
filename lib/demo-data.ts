...
export const DEMO_TRADES: Trade[] = [
  ...
  { id: 13, symbol: "SMCI",  direction: "long",  status: "closed", entry_price: 42.80, stop_loss: 38.50, take_profit: 52.00, exit_price: 36.20, shares: 110, entry_date: "2026-02-09", exit_date: "2026-02-10", pnl: -726.00, notes: "Gapped below stop on accounting concerns rumor. Took the full loss immediately at market open. Lesson: always size for the gap risk on small caps.", tags: "gap-risk,lesson,small-cap", emotions: "Fear, Frustration, Regret", wyckoff_checklist: null, account_size: 50000, commission: 1.00, risk_per_trade: 1, created_at: "2026-02-09T10:20:00", user_id: "guest" },
