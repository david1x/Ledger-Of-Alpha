...
import { LABEL, INITIAL_SETTINGS } from "@/components/settings/types";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <label className="flex items-center justify-between p-3 rounded-lg border dark:border-slate-800 border-slate-100 hover:dark:bg-slate-800/50 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] dark:text-slate-500 text-slate-400">
                Show left-side drawing tools
              </p>
            </div>
            <input
              type="checkbox"
              checked={tvHideSideToolbar !== "true"}
              onChange={(e) => setTvHideSideToolbar(e.target.checked ? "false" : "true")}
          ...
          <label className="flex items-center justify-between p-3 rounded-lg border dark:border-slate-800 border-slate-100 hover:dark:bg-slate-800/50 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] dark:text-slate-500 text-slate-400">
                Show bottom range selector (1D, 5D, 1M...)
              </p>
            </div>
            <input
              type="checkbox"
              checked={tvWithdateranges !== "false"}
              onChange={(e) => setTvWithdateranges(e.target.checked ? "true" : "false")}
              className="w-4 h-4 rounded border-slate-600 text-emerald-500 focus:ring-emerald-500"
            />
          </label>
          ...
          <label className="flex items-center justify-between p-3 rounded-lg border dark:border-slate-800 border-slate-100 hover:dark:bg-slate-800/50 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] dark:text-slate-500 text-slate-400">
                Show description panel on the right
              </p>
            </div>
            <input
              type="checkbox"
              checked={tvDetails === "true"}
              onChange={(e) => setTvDetails(e.target.checked ? "true" : "false")}
              className="w-4 h-4 rounded border-slate-600 text-emerald-500 focus:ring-emerald-500"
            />
          </label>
          ...
          <label className="flex items-center justify-between p-3 rounded-lg border dark:border-slate-800 border-slate-100 hover:dark:bg-slate-800/50 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] dark:text-slate-500 text-slate-400">
                Show gainers/losers on the right
              </p>
            </div>
            <input
              type="checkbox"
              checked={tvHotlist === "true"}
              onChange={(e) => setTvHotlist(e.target.checked ? "true" : "false")}
              className="w-4 h-4 rounded border-slate-600 text-emerald-500 focus:ring-emerald-500"
            />
          </label>
          ...
          <label className="flex items-center justify-between p-3 rounded-lg border dark:border-slate-800 border-slate-100 hover:dark:bg-slate-800/50 hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] dark:text-slate-500 text-slate-400">
                Show events panel on the right
              </p>
            </div>
            <input
              type="checkbox"
              checked={tvCalendar === "true"}
              onChange={(e) => setTvCalendar(e.target.checked ? "true" : "false")}
              className="w-4 h-4 rounded border-slate-600 text-emerald-500 focus:ring-emerald-500"
            />
          </label>
        </div>
          ...
          <div className="space-y-4 rounded-xl dark:bg-slate-800/30 bg-slate-50 p-4 border dark:border-slate-800 border-slate-100">
            <div className="space-y-1">
              ...
              <p className="text-[10px] dark:text-slate-400 text-slate-500 leading-relaxed">
                ...
                To change it: Hover over the &quot;MA&quot; label on the chart → Click the gear icon
                (Settings) → Change Length to 150. Your browser will remember this setting for all
                symbols!
              </p>
            </div>
            <div className="space-y-1">
              ...
              <p className="text-[10px] dark:text-slate-400 text-slate-500 leading-relaxed">
                If Volume is overlapping your price bars: Right-click the Volume bars on the chart →
                Select &quot;Move to...&quot; → &quot;New Pane Below&quot;. This layout is persisted
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] dark:text-slate-400 text-slate-500 leading-relaxed">
                Enabling Details, Hotlist, or Calendar will force the right sidebar to open by
                default. Disable them here for a &quot;borderless&quot; look, and manually click the
                icons on the right of the chart to reveal them when needed.
              </p>
            </div>
          </div>
        </div>
