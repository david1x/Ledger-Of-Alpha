...
export default function AppearanceTab() {
  ...
  const displayState = { heatmapRanges: heatmapRanges as unknown, chartsCollapsed, privacyMode } as Record<string, unknown>;
  const { resetBaseline } = useTabDirty("display", displayState);
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className={CARD}>
          <h2 className="font-semibold dark:text-white text-slate-900 flex items-center gap-2">
            <Eye className="w-4 h-4 text-emerald-400" /> Display Options
          </h2>
